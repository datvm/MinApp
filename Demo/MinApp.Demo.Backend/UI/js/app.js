...
function onLoadFileClick() {
    var filePath = $("#txt-file-path").removeClass("is-invalid").val();

    var variableName = $("#txt-variable-name").removeClass("is-invalid").val();
...
function onExecuteScriptClick() {
    var command = $("#txt-script-command").removeClass("is-invalid").val();
